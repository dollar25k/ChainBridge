...
#[derive(Debug)]
pub struct ChainBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainBridge processing");
    
    let mut processor = ChainBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainBridgeProcessor::new(false);
